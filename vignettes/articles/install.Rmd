...
knitr::include_graphics("figures/ss_1.png")
```
...
```{r, echo=F, out.width="100%"}
knitr::include_graphics("figures/ss_2.png")
```
...
knitr::include_graphics("figures/u_1.png")
```
...
```{r, echo=F, out.width="100%"}
knitr::include_graphics("figures/u_2.png")
```
...
```{r, echo=F, out.width="100%"}
knitr::include_graphics("figures/u_3.png")
```
...
knitr::include_graphics("figures/u_10.png")
```

You have now successfully updated R!

NB: If the latest version of R is not showing correctly in Rstudio, close Rstudio. Now open Rstudio by holding down ctrl while clicking on the Rstudio logo. Now you can choose the correct version of R.

...
knitr::include_graphics("p_1.png")
```
...
knitr::include_graphics("p_2.png")
```

```{r, echo=F, out.width="80%", fig.align = "center"}
knitr::include_graphics("p_3.png")
```

Now R should look like this and is ready for use.

```{r, echo=F, out.width="100%"}
knitr::include_graphics("p_4.png")
```

## Setup new projects

All projects should always be set up using the R project structure. This ensures that R will always be able to identify the correct project folder. It makes loading and saving data more easy as this will always be placed in the correct folder.

First, find the folder of your project and create a new statistics folder

```{r, echo=F, out.width="100%"}
knitr::include_graphics("p_5.png")
```
...
```{r, echo=F, out.width="100%"}
knitr::include_graphics("p_11.png")
```

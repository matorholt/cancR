# incidencR, rates
    ...
    Code
      (rates <- incidencR(redcap_df %>% recodR(list(sex = list(Female = 1, Male = 2))),
      index = date_of_surgery, group = type, unit = 1e+05, reference = "full",
      ci.method = "lognormal", strata = list(c("year"), c("age", "sex"), c("year",
        "type"), c("year", "type", "age"), c("type", "age"), c("year", "age", "sex",
        "type"))))
    Output
      $overall
      # A tibble: 1 x 8
      ...
      # i 1 more variable: weighted_upper <dbl>
      ...
      # i 2 more variables: weighted_lower <dbl>, weighted_upper <dbl>
      ...
      # i 1,070 more rows
      # i 3 more variables: weighted_rate <dbl>, weighted_lower <dbl>,
      #   weighted_upper <dbl>
